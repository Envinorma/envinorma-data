from envinorma.topics.patterns import Topic, TopicName, normalize, tokenize
from envinorma.topics.topics import TopicOntology, detect_matched_patterns, parse
