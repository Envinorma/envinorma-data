from envinorma.enriching.table_row_inline_content import _add_inspection_sheet_in_table_rows, _split_rows
...
def test_add_inspection_sheet_in_table_rows():
    ...
    assert not _add_inspection_sheet_in_table_rows(string).table
    assert _add_inspection_sheet_in_table_rows(string).text == string.text
    ...
    transformed_string = _add_inspection_sheet_in_table_rows(string)
