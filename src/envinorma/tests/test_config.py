...
_CONFIG_FILE = __file__.replace('envinorma/tests/test_config.py', 'config.ini')
_CONFIG_TEMPLATE_FILE = __file__.replace('envinorma/tests/test_config.py', 'config_template.ini')
